...
public class GitlabAPI {
    ...
    public List<GitlabRepositoryFile>  gitLabRepositoryFiles(Serializable projectId){
    	String tailUrl = GitlabProject.URL + "/" + projectId + GitlabRepositoryFile.URL;
    	return retrieve().getAll(tailUrl, GitlabRepositoryFile[].class);
    }
