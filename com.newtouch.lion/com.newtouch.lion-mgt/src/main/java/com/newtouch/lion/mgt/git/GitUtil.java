 ...
 * All rights reserved. 
 *
 * $id: GitUtil.java 9552 2015年3月11日 下午1:37:05 WangLijun$
 */
package com.newtouch.lion.mgt.git;
...
public class GitUtil {
	...
	public final static String REF_REMOTES = "refs/remotes/origin/";

	private static PushCommand push;

	private static Iterable<PushResult> call;
	...
	public static String commitToGitRepository(String gitRoot,List<String> files, String remark) throws Exception {
		if (StringUtils.isNotBlank(gitRoot) && files != null&& files.size() > 0) {
			...
			RevCommit revCommit = commitCmd
					.setCommitter("yonge", "654166020@qq.com")
	 ...
	 * @throws Exception
	 */
	public static boolean rollBackPreRevision(String gitRoot,
			List<DiffEntry> diffEntries, String revision, String remark)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static List<DiffEntry> rollBackFile(String gitRoot, String revision)
			throws Exception {
