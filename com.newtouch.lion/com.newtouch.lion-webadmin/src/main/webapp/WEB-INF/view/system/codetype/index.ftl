...
<!--lang-->
<script src="${base}/resources/global/js/local/lang-zh_CN.js" type="text/javascript"></script>
...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-12">
				  <table class="lion-datagrids table table-striped table-bordered table-hover" id="sys_codetype_lists_tb" data-singleselect="true",   data-loadUrl="/admin/system/codetype/list.json" data-checkbox="true" data-pageSize="10">
					<thead>
						<tr>
