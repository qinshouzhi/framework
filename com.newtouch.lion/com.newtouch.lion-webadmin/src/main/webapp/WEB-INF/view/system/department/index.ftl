...
<div class="portlet light">
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-12">
				 <@lion.datagrids name="sys_department_lists" tableClass="easyui-datagrid" toolbar=""  load="true" url="${base}/system/department/list.htm" dataOptions="" style="height:400px;"/>	
			</div>
		</div>
	</div>
</div>
