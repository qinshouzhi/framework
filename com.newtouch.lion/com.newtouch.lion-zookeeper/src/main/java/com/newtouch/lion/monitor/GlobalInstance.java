...
import com.newtouch.lion.zookeeper.model.ZookeeperSettings;
...
public class GlobalInstance {
	...
	public static String timeOfUpdateZooKeeperStatusSet =StringUtils.EMPTY;

	// 机器HostPerformanceEntity
	private static Map< String/** IP */ , Performance > hostPerformanceEntitySet = new ConcurrentHashMap< String, Performance >();
	// ZooKeeper集群中每台机器状态信息-更新时间
	public static String timeOfUpdateHostPerformanceSet = StringUtils.EMPTY;
	...
	public static ZookeeperSettings zooKeeperSettings = new ZookeeperSettings( 0, "不应该不出我，除非数据库出问题", 2, "不应该不出我，除非数据库出问题" );
	...
	public static void putHostPerformanceEntity( String ip, Performance performance ) {
		hostPerformanceEntitySet.put( ip,performance);
	}

	/** 根据ip获取机器HostPerformanceEntity */
	public static Performance getHostPerformanceEntity( String ip ) {
		return hostPerformanceEntitySet.get( ip );
	}

	/** 将所有机器的HostPerformanceEntity返回 */
	public static Map< String/** IP */
	, Performance > getAllHostPerformanceEntity() {
