...
public class RedisClientImpl extends DefaultClientImpl implements IRedisClient {
	 ...
	 * {@inheritDoc}
	 * 
	 * @Override public Long rpush(final String key, final String value) {
	 * return this.performFunction(key, new CallBack<Long>() { public Long
	 * invoke(Jedis jedis) { return jedis.rpush(key, value); } }); }
	 * 
	 * 存入值
	 * 
	 * @param key 键
	 ...
	 * @return 存入值
	 * 
	 * @Override public Long lpush(final String key, final String value) {
	 * return this.performFunction(key, new CallBack<Long>() { public Long
	 * invoke(Jedis jedis) { return jedis.lpush(key, value); } }); }
	 */
	...
	public Set<Tuple> zrangeByScoreWithScores(final String key,
		...
		return this.performFunction(key, new CallBack<Set<Tuple>>() {
			public Set<Tuple> invoke(Jedis jedis) {
				return jedis.zrangeByScoreWithScores(key, max, min, offset,
						count);
			}
		});
	}
	 ...
	 * 
	 * @param keyValues
	 *            respective keys to the respective values
