...
/**
 * 交易系统响应对像，该模型将返回响应结果给最终用户，包含了响应需要的各种数据，responseNo将对应 {@link com.VehilceRequest.eup.trans.core.model.Request#getRequestNo()} 而且完全相同，transNo（如果有值）将对应
 * {@link com.VehilceRequest.eup.trans.core.model.Request#getRequestNo()}而且完全相同
 * 
 * @author guanrong.xie
